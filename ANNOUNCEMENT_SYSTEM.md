...
## Overview
A full-stack real-time announcement banner system for the Hotel GuestHub hotel app. Admins can create, update, and delete announcements that appear instantly across all client pages via Socket.IO.
